...
class Api::V1::UserManagementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_user_management" do
    assert_difference("Api::V1::UserManagement.count") do
      post api_v1_user_managements_url, params: { api_v1_user_management: { category_id: @api_v1_user_management.category_id, company_name: @api_v1_user_management.company_name, email: @api_v1_user_management.email, package: @api_v1_user_management.package, phone: @api_v1_user_management.phone, social_link: @api_v1_user_management.social_link, username: @api_v1_user_management.username } }, as: :json
    end
  ...
  test "should update api_v1_user_management" do
    patch api_v1_user_management_url(@api_v1_user_management), params: { api_v1_user_management: { category_id: @api_v1_user_management.category_id, company_name: @api_v1_user_management.company_name, email: @api_v1_user_management.email, package: @api_v1_user_management.package, phone: @api_v1_user_management.phone, social_link: @api_v1_user_management.social_link, username: @api_v1_user_management.username } }, as: :json
    assert_response :success
  end
